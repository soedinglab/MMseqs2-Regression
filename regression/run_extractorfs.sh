...
perl "${REFERENCE}" "${DATADIR}/dna.fas" "${RESULTS}/perl_coding_frags"

perl "${EVALUATE}" "${RESULTS}/perl_coding_frags_mode_0.txt" "${RESULTS}/coding_frags_mode_0"
RES0="$?"
perl "${EVALUATE}" "${RESULTS}/perl_coding_frags_mode_1.txt" "${RESULTS}/coding_frags_mode_1"
RES1="$?"
perl "${EVALUATE}" "${RESULTS}/perl_coding_frags_mode_2.txt" "${RESULTS}/coding_frags_mode_2"
RES2="$?"
