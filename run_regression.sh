...
time "${SCRIPTS}/run_easy_nuclnucl_linsearch_split.sh" "${MMSEQS}" "${SAMTOOLS}" "${EVALUATE}" "${DATADIR}" "${RESULTS}/EASY_LINSEARCH_NUCLNUCL_SEARCH_SPLIT"; TESTS="/EASY_LINSEARCH_NUCLNUCL_SEARCH_SPLIT ${TESTS}"
